...
const LightPillar = ({
    ...
    // Changed to fixed position so it covers the whole screen even when scrolling
    return <div ref={containerRef} className={`light-pillar-container fixed inset-0 pointer-events-none ${className}`} style={{ mixBlendMode }} />;
};
